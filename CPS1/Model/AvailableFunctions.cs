namespace CPS1.Model
{
    ...
    {
        private static ImmutableList<Tuple<Signal, Func<double, double, double, double, double, double>, Required>> availableFunctions;

        static AvailableFunctions()
        {
            var list = new List<Tuple<Signal, Func<double, double, double, double, double, double>, Required>>();

            list.Add(
                new Tuple<Signal, Func<double, double, double, double, double, double>, Required>(
        ...
        {
            return availableFunctions.Where(a => a.Item1 == signal).Select(a => a.Item2).FirstOrDefault();
        }

        public static Required GetRequiredParameters(Signal signal)
        {
            return availableFunctions.Where(a => a.Item1 == signal).Select(a => a.Item3).FirstOrDefault();
        }
    }
}
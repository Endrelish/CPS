...
namespace CPS1.Model.ConvolutionFiltrationCorrelation.DistanceSensor
{
    public class SensorSignal
    {
        ...
        {
            FirstPeriod = new FunctionAttribute<double>(11d, true, 1.0d, 100.0d, "PERIOD OF FIRST COMPONENT");
            SecondPeriod = new FunctionAttribute<double>(7d, true, 1.0d, 100.0d, "PERIOD OF SECOND COMPONENT");
